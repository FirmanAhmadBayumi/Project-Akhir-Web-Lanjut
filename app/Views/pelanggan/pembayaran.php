            ...
            <div class="box1">
                <div class="container"><br>
                    <div class="pembayaran">
                        <div class="head">
                            <center>
                                <p class="fw-bold text-dark fs-4">Detail Pembayaran :</p>
                            </center>
                            <div class="text">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="fw-bold text-dark fs-6">ID Pembayaran :</p>
                                        </td>
                                        <td>
                                            <p class="fw-bold text-dark fs-6"></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="fw-bold text-dark fs-6">Nama : </p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="fw-bold text-dark fs-6">Kendaraan</p>
                                        </td>
                                        <td>
                                            <p class="fw-bold text-dark fs-6">:
                                            </p>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="fw-bold text-dark fs-6">Total Pembayaran</p>
                                        </td>
                                        <td>
                                            <p class="fw-bold text-dark fs-6">: RP.</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="fw-bold text-dark fs-6">Tanggal</p>
                                        </td>
                                        <td>
                                            <p class="fw-bold text-dark fs-6">: </p>
                                        </td>
                        ...
                        <div class="pembayaran">
                            <div class="head">
                                <p class="fw-bold text-dark fs-5">Bayar Menggunakan</p>
                                <div class="text">
                                    <table>
                                        <tr>
                                            <td>
                                                <p class="fw-bold text-dark fs-6">Debit Card</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class="fw-bold text-dark fs-6">Dana</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class="fw-bold text-dark fs-6">Ovo</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p class="fw-bold text-dark fs-6">Gopay</p>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <a href="notif_proses_pembayaran.php">
                            <center>
                                <button class="btn btn-light me-md-2" type="button">
                                    <p class="fw-bold text-dark fs-3">Lakukan Pembayaran</p>
                                </button>
                            </center>
                        </a>
                    </div>
