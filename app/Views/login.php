...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url ('login/vendor-login/css-hamburgers/hamburgers.min.css') ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url ('login/vendor-login/animsition/css/animsition.min.css') ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url ('login/vendor-login/select2/select2.min.css') ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url ('login/vendor-login/daterangepicker/daterangepicker.css') ?>">
