...
<body>
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <div class="btn-aksi d-flex justify-content-center">
            <a href="pesanandisetujui.php?id=">
                <button class="btn btn-secondary mr-4">Menyetujui Pesanan</button>
            </a>
            <a href="tidakdisetujui.php?id=">
                <button class="btn btn-secondary">Masukkan Kedalam Antrian</button>
            </a>
        </div>
    </div>
