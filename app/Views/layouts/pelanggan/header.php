    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a href="http://localhost:8080/pemilikusaha/dashboard">Laporan Keuangan</a></li>
                    <li><a href="http://localhost:8080/pemilikusaha/tarif">Tarif Harga</a></li>
                    <li><a href="http://localhost:8080/pemilikusaha/area">Area Pencuician</a></li>
                    <li><a href="http://localhost:8080/logout">Keluar</a></li>
